...
const TaskColumn = ({ col, tasks, onEditTask }) => {
  ...
  return (
    <div className=" h-[700px] w-80 md:w-auto shrink-0 bg-white/[0.03] border border-white/[0.08] backdrop-blur-md rounded-2xl p-5 flex flex-col gap-4 shadow-xl transition-all duration-300 hover:bg-white/[0.04] hover:border-white/[0.12] group">
      {/* Column Header */}
      ...
      {/* Column Content Area */}
      <div className="flex-1 max-h-[700px] overflow-y-auto min-h-0 custom-scrollbar rounded-xl border border-dashed border-white/[0.05] bg-slate-950/20 flex flex-col gap-3 p-4 transition-colors hover:bg-slate-950/40">
